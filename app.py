...
def add_user_to_g():
    ...
    if not g.user and request.endpoint not in ("do_login", 
        "do_logout", "signup", "login", 
        "logout", "list_users", "users_show", 
        "messages_show", "homepage", "add_header"):
        flash("Access unauthorized.", "danger", "homepage")
        return redirect("/")
